...
def make_entrez_query_tool(query: str) -> str:
    """
    Convert a natural language question into a high-quality Entrez
...
def remake_entrez_query_tool(bad_query: str) -> str:
    """
    Loosen, simplify, or rework a PubMed/Entrez query that returned 0 results. Remove overly strict filters, rare fields,
